...
// Get counter number from URL or default to 1
$counter_number = intval($_GET['counter'] ?? 1);

// Get all queue entries for this counter (active: waiting, serving, assessed, paid)
$sql = $conn->prepare("
    SELECT 
        q.id,
        q.queue_number,
...
$sql->bind_param("si", $today, $counter_number);
$sql->execute();
